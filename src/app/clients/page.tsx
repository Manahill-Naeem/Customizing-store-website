// 'use client'; // This page does not require client-side interactivity, so 'use client' is not necessary.
  ...
  const testimonials = [
    {
      ...
      image: '/clients/abc-engineering.jpg', // Make sure this path is correct
    ...
    },
    {
      ...
      image: '/clients/xyz-manufacturing.jpg', // Make sure this path is correct
    ...
    },
    {
      ...
      image: '/clients/global-petrochemicals.jpg', // Make sure this path is correct
      ...
      <section className="relative h-[400px] w-full overflow-hidden">
        ...
        <img
          ...
          onError={(e) => { // Error handling for image
            ...
            (e.target as HTMLImageElement).src = 'https://placehold.co/1200x400/cccccc/000000?text=Our+Clients'; // Placeholder image
          }}
        />
                ...
                <div className="flex items-center mb-4">
                  <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4">
                    ...
                    <img
                      ...
                      className="object-cover w-full h-full rounded-full" // Added rounded-full for circular images
                      onError={(e) => { // Error handling for testimonial images
                        (e.target as HTMLImageElement).srcset = '';
                        (e.target as HTMLImageElement).src = `https://placehold.co/64x64/cccccc/000000?text=${testimonial.name.charAt(0)}`; // Placeholder with initial
                      }}
                    />
                  </div>
                  <div>
