  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[400px]">
        ...
        <Image
          src="/hero-bg.jpg"
          alt="About Optivance-Inspect"
          fill
          className="object-cover"
          priority
        />
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-white">About Optivance-Inspect</h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px]">
              <Image
                src="/about.jpg"
                alt="Optivance-Inspect Laboratory"
                fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Optivance-Inspect is driven by clearly defined vision and strives to add value to its client's businesses by providing world-class solutions while remaining cost-effective.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3">Quality</h3>
              <p className="text-gray-600">
                Optivance-Inspect believes in assisting its clients to meet their responsibilities for quality by providing them with reliable, accurate and representative data and professional consulting services.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3">Safety</h3>
              <p className="text-gray-600">
                Optivance-Inspect Services Pty. Ltd is committed to a clean, safe and healthy work environment for its employees working in its premises or on-site.
              </p>
            </div>
          </div>
        </div>
