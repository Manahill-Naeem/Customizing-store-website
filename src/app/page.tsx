      ...
      {loadingBanner ? (
        ...
        activeSale && activeSale.isActive ? (
          ...
          <section className="flex flex-col items-center justify-center text-center py-16 px-4 bg-primary-50 mt-16">
            ...
            <Link href="/shop" className="inline-block px-8 py-3 rounded-full bg-gold text-primary-800 font-bold text-lg shadow-lg hover:bg-yellow-500 transition">Explore Products</Link>
          </section>
        )
      )}
